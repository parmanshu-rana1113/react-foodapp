...
export const getOrders = async (req: Request, res: Response) => {
    ...
    try {
        console.log('User ID:', req.id);  // Debugging user ID
        const orders = await Order.find({ user: req.id }).populate('user').populate('restaurant');
        console.log('Fetched Orders:', orders);  // Check if orders are returned
...
export const createCheckoutSession = async (req: Request, res: Response) => {
    try {
        ...
        console.log('Menu Items:', restaurant.menus);
        console.log('Cart Items:', checkoutSessionRequest.cartItems);
...
// export const createLineItems = (createCheckoutSessionRequest: CheckoutSessionRequest, menuItems: any) => {
...
export const createLineItems = (createCheckoutSessionRequest: CheckoutSessionRequest, menuItems: any) => {
    ...
    console.log('Cart Items:', createCheckoutSessionRequest.cartItems);
