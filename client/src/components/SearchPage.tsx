...
const SearchPage = () => {
  ...
  useEffect(() => {
    searchRestaurant(params.text!, searchQuerry, appliedFilter);
    console.log('Filtered Data:', searchedRestaurant?.data);
      ...
      <div className="flex flex-col md:flex-row justify-between gap-10">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <Button onClick={() => searchRestaurant(params.text!, searchQuerry, appliedFilter)} className="bg-orange hover:bg-hoverorange">Search</Button>

          </div>

          {/* search item display here  */}
          <div>
            <div className="flex flex-col gap-3 md:flex-row md:item-center md:gap-2 my-3">

              <h1 className="font-medium text text-xl">({searchedRestaurant?.data.length}) Search result found</h1>
                    ...
                    return (
                      <div key={idx} className="relative inline-flex max-w-full">
                        ...
                        <X
                          ...
                          size={15}
                          className="absolute text-[#D19254] right-1 hover:cursor-pointer top-2"
                        />
                      </div>
                    );
                  })
                  ...
                  !loading && searchedRestaurant?.data.length === 0 ?
                    ...
                    (
                      ...
                      searchedRestaurant?.data.map((restaurant: Restaurant) => (
                        ...
                        <Card key={restaurant._id} className="bg-white dark:gb-gray-800 shadow-xl rounded-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300 w-full sm:w-64 lg:w-[250px] lg:h-[350px]">
                          ...
                          <CardContent className="p-4">
                            ...
                            <div className="mt-2 gap-1 flex items-center text-gray-600 dark:text-gray-400">
                              ...
                              <p className=" text-sm">
                                state:{" "}
                                <span className="font-medium ">{restaurant.state}</span>
                              </p>
                            </div>
                          ...
                          <CardFooter className="p-4 border-t dark:border-t-gray-700 border-t-gray-100 text-white flex justify-end">
                            <Link to={`/restaurant/${restaurant._id}`}>
                              <Button className="bg-orange hover:bg-hoverorange font-semibold py-2 px-4 rounded-full  shadow-md transition-colors duration-200">View Menu</Button>
                            </Link>
                          </CardFooter>
                        </Card>
