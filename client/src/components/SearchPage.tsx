                ...
                <div className="flex-1">
                    ...
                    <div>
                        <div className="flex flex-col gap-3 md:flex-row md:item-center md:gap-2 my-3" >
                            ...
                            <h1 className="font-medium text text-xl"> (2) search result found</h1>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">

                            {
                                [1, 2, 3, 4, 5, 6].map((item: number, idx: number) => (
                                    ...
                                    <Card className="bg-white dark:gb-gray-800 shadow-xl rounded-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300 w-full sm:w-64 lg:w-[250px] lg:h-[350px]">
                                        ...
                                        <CardContent className="p-4">
                                            {/* restaurant name */}
                                            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Tandoori Tadka</h1>

                                            <div className="mt-2 gap-1 flex items-center text-gray-600 dark:text-gray-400">
                                                <MapPin size={16} />
                                                <p className=" text-sm">
                                                    city:{" "}
                                                    <span className="font-medium ">Yamunanagar</span>
                                                </p>
                                            </div>
                                            <div className="mt-2 gap-1 flex items-center text-gray-600 dark:text-gray-400">
                                                <Globe size={16} />
